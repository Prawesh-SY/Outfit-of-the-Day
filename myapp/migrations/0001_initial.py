    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', colorfield.fields.ColorField(default='#FF0000', image_field=None, max_length=25, samples=None)),
            ],
        ),
        migrations.CreateModel(
            name='Occasion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('underbust', models.FloatField(help_text='Measurement in inches', validators=[django.core.validators.MinValueValidator(24), django.core.validators.MaxValueValidator(60)])),
                ('overbust', models.FloatField(help_text='Measurement in inches', validators=[django.core.validators.MinValueValidator(24), django.core.validators.MaxValueValidator(80)])),
                ...
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bra_size', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occasions', models.ManyToManyField(blank=True, related_name='outfit_images', to='myapp.occasion')),
                ('style', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='myapp.style')),
            ],
            options={
                'ordering': ['-created_at'],
            },
